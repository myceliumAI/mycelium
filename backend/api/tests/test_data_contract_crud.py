...
class TestDataContractCRUD:
    ...
    @pytest.fixture
    def sample_data_contract(self) -> DataContractCreate:
    ...
    def test_create_data_contract(self, db_session: Session, sample_data_contract: DataContractCreate):
    ...
    def test_get_data_contract(self, db_session: Session, sample_data_contract: DataContractCreate):
    ...
    def test_get_nonexistent_data_contract(self, db_session: Session):
        """Test retrieving a non-existent data contract."""
        retrieved = get_data_contract(db_session, "nonexistent-id")
        assert retrieved is None

    def test_update_data_contract(self, db_session: Session, sample_data_contract: DataContractCreate):
        ...
        update_data = DataContractCreate(
            **{**sample_data_contract.model_dump(),
               "info": InfoObject(
                   **{**sample_data_contract.info.model_dump(),
                      "title": "Updated Title"
                   }
               )
            }
    ...
    def test_delete_data_contract(self, db_session: Session, sample_data_contract: DataContractCreate):
